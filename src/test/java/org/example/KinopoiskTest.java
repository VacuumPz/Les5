...
//Через Actions почему то не работает
//        getDriver().findElement(By.xpath(".//button[text() = 'Войти']")).click();
//        Actions testLogin = new Actions(getDriver());
//        testLogin.sendKeys(getDriver().findElement(By.xpath(".//input[@name = 'login']")),"testid", Keys.ENTER)
//                .sendKeys(getDriver().findElement(By.xpath(".//input[@name = 'passwd']")), "passwd", Keys.ENTER)
//                .build()
//                .perform();
